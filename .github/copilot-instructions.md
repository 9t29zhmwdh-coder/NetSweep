# Copilot Instructions for NetSweep
NetSweep is a Windows desktop application (WPF, .NET 8) for auditing and cleaning up network drives: NAS shares, UNC paths, mapped SharePoint libraries and DFS namespaces. It helps manage connections, visualize storage usage, detect duplicates and remove stale files with full audit trail support.
## Code style
