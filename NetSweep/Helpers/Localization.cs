...
public sealed class Localization : INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, (string En, string De)> Strings = new()
    {
        ...
        ["StatusConnectionAdded"] = ("Connection added.", "Verbindung hinzugefuegt."),
        ...
        ["AccessDenied"] = ("Access denied. Check username or password.", "Zugriff verweigert. Benutzername oder Passwort pruefen."),
        ...
        ["Save"] = ("Save", "Speichern"),
        ["ChooseFolderTitle"] = ("Choose folder / network drive", "Ordner / Netzlaufwerk waehlen"),
        ["ChooseQuarantineFolderTitle"] = ("Choose quarantine folder", "Quarantaene-Ordner waehlen"),
        ...
        ["DeleteConfirmFormat"] = ("Permanently delete {0} file(s) ({1})?", "{0} Datei(en) ({1}) endgueltig loeschen?"),
        ["DeleteConfirmTitle"] = ("Really Delete?", "Wirklich loeschen?"),
        ...
        ["DeleteResultPrefix"] = ("Delete: ", "Loeschen: "),
        ["ChooseQuarantineFolderPrompt"] = ("Choose quarantine folder", "Quarantaene-Ordner waehlen"),
        ["MoveToQuarantineConfirmFormat"] = ("Move {0} file(s) to\n{1}\n(quarantine)?", "{0} Datei(en) nach\n{1}\nverschieben (Quarantaene)?"),
        ["MoveToQuarantineTitle"] = ("Move to Quarantine", "In Quarantaene verschieben"),
        ["QuarantineResultPrefix"] = ("Quarantine: ", "Quarantaene: "),
        ["ChooseCopyTargetTitle"] = ("Choose target folder for copy / backup", "Zielordner fuer Kopie / Backup waehlen"),
